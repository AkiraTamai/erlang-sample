...
%Process spawn time=0.0 (9.0) ms
%ok
%2> measure_processes:limit(10000).
%Limit allowed processes:262144
%Process spawn time=4.0 (8.6) ms
%ok
%3> measure_processes:limit(100000).
%Limit allowed processes:262144
%Process spawn time=3.9 (8.84) ms
%ok
%4> measure_processes:limit(200000).
%Limit allowed processes:262144
%Process spawn time=3.6 (8.34) ms
%ok
%5> measure_processes:limit(210000).
%Limit allowed processes:262144
%Process spawn time=3.9047619047619047 (8.790476190476191) ms
%ok
